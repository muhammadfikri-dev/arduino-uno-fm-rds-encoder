# ⚡ Arduino Uno FM Stereo RDS (Radio Data System) 57kHz Subcarrier Modulator
...
Broadcast RDS subcarrier generator generating differential biphase Manchester-encoded data blocks, PI/PS/RT text strings, and modulating 57kHz crystal subcarrier.
...
3. Pastikan dependensi pustaka terpasang via Library Manager:
   ...
   * `Wire` & `SPI`
   * `EEPROM`
4. Buka berkas [`arduino-uno-fm-rds-encoder.ino`](./arduino-uno-fm-rds-encoder.ino).
