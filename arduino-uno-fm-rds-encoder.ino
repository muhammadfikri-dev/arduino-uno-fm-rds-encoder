/**
 * =========================================================================================
 * Project     : Arduino Uno FM Stereo RDS (Radio Data System) 57kHz Subcarrier Modulator
 * Platform    : Arduino Uno / ATmega328P
 * Framework   : Arduino IDE 2.0+
 * Author      : Muhammad Fikri
 * License     : MIT
 * Description : Broadcast RDS subcarrier generator generating differential biphase Manchester-encoded data blocks, PI/PS/RT text strings, and modulating 57kHz crystal subcarrier.
 * =========================================================================================
 */
...
void setup() {
    ...
    Serial.println(F("================================================================="));
    Serial.println(F(" Arduino Uno FM Stereo RDS (Radio Data System) 57kHz Subcarrier Modulator"));
